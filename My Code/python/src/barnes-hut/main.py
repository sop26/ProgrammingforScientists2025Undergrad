...
def main():
    ...
    print("Initialize galaxies")
    # --- initialize galaxies ---
    g0 = initialize_galaxy(num_stars, 12e21, 5.0e22 - 30.0e21, 5.0e22+30.0e21)
    push(g0, OrderedPair(0, 0))
    g1 = initialize_galaxy(num_stars, 12e21, 5.0e22 + 30.0e21, 5.0e22 + 30.0e21)
    push(g1, OrderedPair(0, 0))
    g2 = initialize_galaxy(num_stars, 12e21, 5.0e22, 5.0e22-15.0e21)
    push(g2, OrderedPair(0, 0))
    ...
    output_filename = f"galaxy_{num_stars}.mp4"
    fps = 30
